...
func TestSerialize(t *testing.T) {
	...
	assert.Equal(t, `{"paperNumber":"somepaper","issuer":"someissuer","issueDateTime":"sometime","faceValue":1000,"maturityDateTime":"somelatertime","owner":"someowner","state":2}`, string(bytes), "should return JSON formatted value")
}
...
func TestDeserialize(t *testing.T) {
	...
	goodJSON := `{"paperNumber":"somepaper","issuer":"someissuer","issueDateTime":"sometime","faceValue":1000,"maturityDateTime":"somelatertime","owner":"someowner","state":2}`
	...
	badJSON := `{"paperNumber":"somepaper","issuer":"someissuer","issueDateTime":"sometime","faceValue":"NaN","maturityDateTime":"somelatertime","owner":"someowner","state":2}`
	cp = new(CommercialPaper)
